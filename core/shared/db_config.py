...
def get_db_config() -> Dict[str, str]:
    ...
    if env == "test":
        return {
            "host": _pick("TEST_DB_HOST", "DB_HOST", "PGHOST", "POSTGRES_HOST", default="127.0.0.1"),
            "port": _pick("TEST_DB_PORT", "DB_PORT", "PGPORT", "POSTGRES_PORT", default="5432"),
            "database": _pick("TEST_DB_NAME", "DB_NAME", "PGDATABASE", "POSTGRES_DB", default="workout_tracker_test"),
            "user": _pick("TEST_DB_USER", "DB_USER", "PGUSER", "POSTGRES_USER", default="postgres"),
            "password": _pick("TEST_DB_PASSWORD", "DB_PASSWORD", "PGPASSWORD", "POSTGRES_PASSWORD", default=""),
        }
    # prod
    return {
        "host": _pick("DB_HOST", "PGHOST", "POSTGRES_HOST", default="127.0.0.1"),
        "port": _pick("DB_PORT", "PGPORT", "POSTGRES_PORT", default="5432"),
        "database": _pick("DB_NAME", "PGDATABASE", "POSTGRES_DB", default="workout_tracker"),
        "user": _pick("DB_USER", "PGUSER", "POSTGRES_USER", default="postgres"),
        "password": _pick("DB_PASSWORD", "PGPASSWORD", "POSTGRES_PASSWORD", default=""),
    }
