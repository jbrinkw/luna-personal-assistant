#!/usr/bin/env python3
"""
Run all Phase 1B tests and output structured results
"""
import json
import subprocess
import sys
...
def main():
    ...
    test_modules = [
        "test_1b1_config_sync",
        "test_1b2_master_config"
    ]
    ...
    for module in test_modules:
        try:
            ...
            results["tests"].append({
                "test": module,
                "status": "timeout",
                "error": "Test module timed out after 120 seconds"
            })
        except Exception as e:
