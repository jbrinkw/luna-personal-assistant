...
class SimpleAgent:
    ...
    def __init__(self, client: Client):
        ...
        self.tool_map = {
            ...
            "plan meals": "action_run_meal_suggestion_generator",
    ...
    async def run(self, prompt: str) -> str:
        ...
        elif tool in {"push_update_taste_profile", "action_run_meal_suggestion_generator", "action_run_new_meal_ideator"}:
